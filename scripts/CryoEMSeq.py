...
if __name__=="__main__":
    ...
    for key, value in len_frag_filt.items():
        if not os.path.exists(main_folder+"/result/frag"+str(key)+".txt"):
            print("perl " + script_path+"/P2_run_qprob_on_pdb_batch.pl "+frag_dir+"/frag"+str(key)+" "+tools_dir+" "+main_folder+"/result/frag"+str(key)+".txt")
            os.system("perl " + script_path+"/P2_run_qprob_on_pdb_batch.pl "+frag_dir+"/frag"+str(key)+" "+tools_dir+" "+main_folder+"/result/frag"+str(key)+".txt")
